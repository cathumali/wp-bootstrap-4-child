	  	...
	  	<div class="contents" style="background: #f8f9fa">
			...
			<?php else : ?>
				<div class="entry-summary">
					...
					?>
					<div class="">
						<a href="<?php echo esc_url( get_permalink() ); ?>" class="btn btn-primary btn-sm"><?php esc_html_e( 'Learn More', 'wp-bootstrap-4' ); ?> <small class="oi oi-chevron-right ml-1"></small></a>
					</div>
				</div><!-- .entry-summary -->
			<?php endif; ?>
	    </div>
